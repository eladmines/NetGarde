...
class BlockedSiteService:
    """Implementation of IBlockedSiteService."""
    
    def create_blocked_site(self, blocked_site_data: BlockedSiteCreate, db: Session):
    ...
    def get_blocked_site_by_id(self, blocked_site_id: int, db: Session):
        repository = BlockedSiteRepository(db)
        try:
    ...
    def get_blocked_site_by_domain(self, blocked_site_domain: str, db: Session):
        repository = BlockedSiteRepository(db)
        try:
    ...
    def get_blocked_sites(self, db: Session, page: int = 1, page_size: int = 10, domain_search: str = None):
        repository = BlockedSiteRepository(db)
        try:
    ...
    def update_blocked_site(self, blocked_site_id: int, blocked_site_data: BlockedSiteCreate, db: Session):
        repository = BlockedSiteRepository(db)
        try:
    ...
    def delete_blocked_site(self, blocked_site_id: int, db: Session):
        repository = BlockedSiteRepository(db)
        try:
    ...
    def get_blocked_sites_counts_by_category(self, db: Session):
        repository = BlockedSiteRepository(db)
        try:
